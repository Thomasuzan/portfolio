...
<head>
  ...
  <!--favicon -->
  <link rel="apple-touch-icon" sizes="60x60" href="<?= BASE_URL ?>/assets/favicons/apple-touch-icon.png">
  ...
  <!-- Open-graph  -->
  <meta property="og:title" content="<?= $title_page ?? 'Thomas | portfolio' ?>" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://thomasuzan.fr<?php echo $_SERVER['REQUEST_URI']; ?>" />
  <meta property="og:image" content="https://thomasuzan.fr/assets/img/picture/home/thomas-hero.jpg" />
  <meta property="og:site_name" content="Thomasuzan" />
  ...
  <!-- Javascript libs -->
  <script defer src="<?= BASE_URL ?>/assets/js/libs/jquery-3.5.1.min.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/jquery.pagepiling.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/jquery.fancybox.min.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/animsition.min.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/aos.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/swiper-bundle.min.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/jquery.easy_number_animate.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/jquery.marquee.min.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/isotope.pkgd.min.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/packery.pkgd.min.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/packery-mode.pkgd.min.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/libs/simpleParallax.min.js"></script>

  <!-- JavaScript -->
  <script defer src="<?= BASE_URL ?>/assets/js/main.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/moveDiv.js"></script>
  <script defer src="<?= BASE_URL ?>/assets/js/focusMessage.js"></script>
  ...
  <div class="animsition">
    <header class="header header--secondary header--absolute __js_fixed-header header--height">
      <div class="header__container container container--size-large">
        <a href="<?= $router->generate('home') ?>" class="header__logo logo flex">
          <img src="<?= BASE_URL ?>/assets/img/picture/logo/logo-header-secondary.png" alt="hexagone bleu">
          <div id="logo-nom">thomas<span>uzan</span></div>
        </a>
        <div class="header__mobile mobile-canvas">
          <nav class="mobile-canvas__nav navigation">
            <ul class="navigation__list nav-header">
              <li class="navigation__item <?php if ($_SERVER['REQUEST_URI'] == '/') : ?>navigation__item--current<?php endif; ?>">
                <a class="navigation__link animsition-link"
                  href="<?= $router->generate('home') ?>">Accueil<span class="navigation__link-icon">
              ...
              <li class="navigation__item <?php if ($_SERVER['REQUEST_URI'] != '/' && str_contains('/about', $_SERVER['REQUEST_URI'])) : ?>navigation__item--current<?php endif; ?>">
                <a class="navigation__link animsition-link"
                  href="<?= $router->generate('about') ?>">à-propos<span class="navigation__link-icon">
                    <svg width="12" height="13">
                      <use xlink:href="#link-arrow"></use>
                    </svg>
                  </span>
              ...
              <li class="navigation__item <?php if ($_SERVER['REQUEST_URI'] != '/' && str_contains('/projects', $_SERVER['REQUEST_URI'])) : ?>navigation__item--current<?php endif; ?>">
                <a class="navigation__link animsition-link"
                  href="<?= $router->generate('projects') ?>">projets<span class="navigation__link-icon">
                    <svg width="12" height="13">
                      <use xlink:href="#link-arrow"></use>
                    </svg>
                  </span>
              ...
              <!-- <li class="navigation__item <?php if ($_SERVER['REQUEST_URI'] != '/' && str_contains('/blog', $_SERVER['REQUEST_URI'])) : ?>navigation__item--current<?php endif; ?>">
                <a class="navigation__link animsition-link"
                  href="<?= $router->generate('blog') ?>">Blog<span class="navigation__link-icon">
                    <svg width="12" height="13">
                      <use xlink:href="#link-arrow"></use>
                    </svg>
                  </span>
              ...
              <li class="navigation__item <?php if ($_SERVER['REQUEST_URI'] != '/' && str_contains('/contact', $_SERVER['REQUEST_URI'])) : ?>navigation__item--current<?php endif; ?>">
                <a class="navigation__link animsition-link"
                  href="<?= $router->generate('contact') ?>">Contact<span class="navigation__link-icon">
                    <svg width="12" height="13">
                      <use xlink:href="#link-arrow"></use>
                    </svg>
                  </span>
        ...
        <div class="mobile-canvas__phone d-flex" style="gap:30px">
          <a class="flex" href="https://linkedin.com/in/thomas-uzan">
            <img src="<?= BASE_URL ?>/assets/img/picture/logo/linked.png" alt="linkedin">
          </a>
          <a class="flex" href="https://github.com/Thomasuzan">
            <img src="<?= BASE_URL ?>/assets/img/picture/logo/github.png" alt="github">
          </a>
        </div>
      </div>
    </header>
    ...
    <footer class="footer __js_fixed-footer">
      <div class="footer__container container container--size-large">
        <div class="footer__grid">
          <a href="<?= $router->generate('home') ?>" class="footer__logo">
            <img height="242"
              src="<?= BASE_URL ?>/assets/img/picture/logo/logo-vertical.png" alt="thomas uzan écrit en vertical">
          </a>
          ...
          <div class="footer__menu">
            ...
            <ul class="footer__menu-list">
              <li class="footer__menu-item">
                <a class="footer__menu-link" href="<?= $router->generate('home') ?>">Accueil</a>
              </li>
              <li class="footer__menu-item">
                <a class="footer__menu-link" href="<?= $router->generate('about') ?>">à-propos</a>
              </li>
              <li class="footer__menu-item">
                <a class="footer__menu-link" href="<?= $router->generate('projects') ?>">projets</a>
              </li>
              <!-- <li class="footer__menu-item">
                <a class="footer__menu-link" href="<?= $router->generate('blog') ?>">blog</a>
              </li> -->
              <li class="footer__menu-item">
                <a class="footer__menu-link" href="<?= $router->generate('contact') ?>">contact</a>
              </li>
            </ul>
          </div>
          <div class="footer__menu">
            <div class="footer__title">Follow</div>
            <ul class="footer__menu-list logo-follow">
              <li>
                <a href="https://linkedin.com/in/thomas-uzan">
                  <img src="<?= BASE_URL ?>/assets/img/picture/logo/linked.png" alt="linkedin">
                </a>
              </li>
              <li>
                <a href="https://github.com/Thomasuzan">
                  <img src="<?= BASE_URL ?>/assets/img/picture/logo/github.png" alt="github">
                </a>
              </li>
            </ul>
          ...
          <div class="footer__feedback">
            <div class="footer__title">Inscrivez-vous à ma newsletter</div>
            ...
            <div class="footer__feedback-notice">Ce site est protégé par reCAPTCHA et la <a href="https://policies.google.com/privacy?hl=fr">
                Politique de confidentialité Google</a> et <a href="https://policies.google.com/terms?hl=fr">les Conditions d'utilisation de Google s'appliquent.</a>
            </div>
          </div>
          <div class="footer__bottom">
            <div class="footer__copyright">© Centrix 2021. All Rights Resevered</div>
            <a class="footer__legal-link" href="<?= $router->generate('site_map') ?>">Plan du site</a>
            <a class="footer__legal-link" href="<?= $router->generate('legal_notice') ?>">Mentions légales</a>
            <a class="footer__legal-link" href="<?= $router->generate('privacy_policy') ?>">Politique de confidentialité</a>
          </div>
        </div>
      </div>
    </footer>
